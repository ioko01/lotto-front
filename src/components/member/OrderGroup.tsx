                                                            ...
                                                            <Fragment key={i}>
                                                                {
                                                                    ...
                                                                    <tr key={i}>
                                                                        ...
                                                                        <td className="border border-slate-300 text-green-600">{(price[i] - commission[i]).toFixed(2) ?? 0}</td>
                                                                        <td className="border border-slate-300">{commission[i].toFixed(2) ?? 0}</td>
